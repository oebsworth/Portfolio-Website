...
const HomePage = () => {
  return (
    <main className='gradient-background flex flex-col justify-start items-center text-white'>
      ...
      <Image src="/images/profile.png" width={256} height={256} alt='Profile Image' className='rounded-full' />
      ...
      <div className='pb-4'>
        <button><Image src="/images/kitchen-chaos.png" width={128} height={128} alt="Kitchen Chaos" className='rounded-full' /></button>
      </div>
    </main>
  )
}
